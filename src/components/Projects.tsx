...
export function Projects() {
  ...
  const projects: Project[] = [
    {
      ...
      year: "2024",
      description: "Un proyecto de transformación digital completo que llevó a Asgardia a convertirse en la plataforma de bienes raíces líder en la región. Creamos una experiencia inmersiva que combina diseño elegante con funcionalidad intuitiva.",
      services: ["Brand Strategy", "Website Design", "UX/UI Design", "Development"],
      image: "https://images.unsplash.com/photo-1636247497842-81ee9c80f9df?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwb3J0Zm9saW8lMjB3ZWIlMjBkZXNpZ258ZW58MXx8fHwxNzYxMDc4MDA4fDA&ixlib=rb-4.1.0&q=80&w=1080",
      images: [
    ...
    },
    {
      ...
      category: "E-commerce",
      year: "2024",
      description: "Diseño de comercio electrónico de lujo que redefinió la experiencia de compra online. Implementamos un sistema de diseño cohesivo que refleja la exclusividad de la marca.",
      services: ["Visual Identity", "E-commerce Design", "Photography Direction"],
      image: "https://images.unsplash.com/photo-1616205255812-c07c8102cc02?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxicmFuZCUyMGlkZW50aXR5JTIwbW9ja3VwfGVufDF8fHx8MTc2MDk4MjQ3NHww&ixlib=rb-4.1.0&q=80&w=1080",
      images: [
    ...
    },
    {
      ...
      year: "2023",
      description: "Plataforma SaaS completa para gestión de proyectos. Diseño centrado en el usuario que simplifica flujos de trabajo complejos manteniendo una estética moderna y profesional.",
      services: ["UX Research", "UI Design", "Prototyping", "Development"],
      image: "https://images.unsplash.com/photo-1609921212029-bb5a28e60960?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2JpbGUlMjBhcHAlMjBkZXNpZ258ZW58MXx8fHwxNzYwOTg0NzQ4fDA&ixlib=rb-4.1.0&q=80&w=1080",
      images: [
    ...
    },
    {
      ...
      year: "2023",
      description: "Identidad visual completa para una startup tecnológica innovadora. Desde el concepto hasta la ejecución, creamos una marca que destaca en el competitivo mercado tech.",
      services: ["Brand Identity", "Website Design", "Marketing Assets"],
      image: "https://images.unsplash.com/photo-1658297063569-162817482fb6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlY29tbWVyY2UlMjB3ZWJzaXRlfGVufDF8fHx8MTc2MDk4NjE2N3ww&ixlib=rb-4.1.0&q=80&w=1080",
      images: [
        "https://images.unsplash.com/photo-1658297063569-162817482fb6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlY29tbWVyY2UlMjB3ZWJzaXRlfGVufDF8fHx8MTc2MDk4NjE2N3ww&ixlib=rb-4.1.0&q=80&w=1080",
        "https://images.unsplash.com/photo-1616205255812-c07c8102cc02?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxicmFuZCUyMGlkZW50aXR5JTIwbW9ja3VwfGVufDF8fHx8MTc2MDk4MjQ3NHww&ixlib=rb-4.1.0&q=80&w=1080",
      ],
  ...
  return (
    <section id="proyectos" className="py-32 bg-white dark:bg-[#0a0a0a] transition-colors duration-500">
            ...
            >
              <div className="relative aspect-[4/3] overflow-hidden bg-[#1a1a1a]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                  ...
                  >
                    <span className="font-['Archivo',sans-serif] text-[10px] tracking-[0.3em] uppercase text-white/60 mb-2 block italic" style={{ fontWeight: 400 }}>
                      ({project.category} - {project.year})
                    </span>
                    <h3 className="font-['Archivo',sans-serif] text-[42px] md:text-[52px] leading-[0.9] tracking-[-0.02em] text-white mb-2" style={{ fontWeight: 900 }}>
                      {project.title}
                    </h3>
                  </motion.div>
                ...
                <div className="absolute top-8 right-8">
                  <span className="font-['Archivo',sans-serif] text-[64px] text-white/10 group-hover:text-white/20 transition-colors" style={{ fontWeight: 900 }}>
              ...
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="bg-[#0a0a0a] relative min-h-[400px] lg:min-h-[600px]">
                  ...
                  <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-black/50 backdrop-blur-sm px-4 py-2 rounded-full">
                    <span className="text-white font-['Archivo',sans-serif] text-[12px] tracking-[0.1em]" style={{ fontWeight: 600 }}>
                ...
                <div className="p-12 lg:p-16 flex flex-col justify-center">
                  <span className="font-['Archivo',sans-serif] text-[10px] tracking-[0.3em] uppercase text-[#28292D]/50 dark:text-white/50 mb-6 block italic" style={{ fontWeight: 400 }}>
                    ({selectedProject.category} - {selectedProject.year})
                  </span>

                  <h3 className="font-['Archivo',sans-serif] text-[56px] md:text-[72px] leading-[0.9] tracking-[-0.02em] text-[#28292D] dark:text-white mb-6" style={{ fontWeight: 900 }}>
                    {selectedProject.title}
                  </h3>

                  <p className="font-['Archivo',sans-serif] text-[16px] md:text-[18px] text-[#28292D]/70 dark:text-white/70 leading-[1.7] mb-10" style={{ fontWeight: 400 }}>
                    {selectedProject.description}
                  </p>

                  {/* Services */}
                  <div className="mb-10">
                    <h4 className="font-['Archivo',sans-serif] text-[12px] tracking-[0.2em] uppercase text-[#28292D]/50 dark:text-white/50 mb-4" style={{ fontWeight: 600 }}>
                      Services
                    </h4>
