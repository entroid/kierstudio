  ...
  const solutions = [
    {
      ...
      description: "Aplicamos diseño UX/UI estratégico para que cada pantalla tenga un propósito claro. Simplificamos flujos, mejoramos la legibilidad y guiamos al usuario hacia la acción sin fricciones.",
    ...
    },
    {
      ...
      description: "Rediseñamos tu sitio o landing con enfoque en conversión. Optimizamos estructura, jerarquía visual y mensaje, para que tus visitantes entiendan por qué elegirte y tomen acción.",
      image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&q=80",
    },
    {
      title: "Cuando tu equipo se satura con tareas repetitivas",
      subtitle: "Optimización con agentes de IA.",
      description: "Automatizamos procesos con agentes de IA que atienden consultas, agendan citas o responden mensajes. Ganás tiempo, reducís costos y mejorás la experiencia de tus clientes.",
      image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=600&q=80",
    },
    {
      title: "Cuando tu identidad ya no representa a tu negocio",
      subtitle: "Branding digital.",
      description: "Actualizamos tu branding digital para que refleje quién sos hoy. Creamos una identidad visual coherente, moderna y adaptable a tus productos digitales.",
      image: "https://images.unsplash.com/photo-1561070791-2526d30994b5?w=600&q=80",
    },
    {
      title: "Cuando tu producto creció, pero el diseño no lo acompañó",
      subtitle: "Consultoría y diseño UX/UI",
      description: "Auditamos y rediseñamos la interfaz con una visión integral. Detectamos puntos de fricción, reorganizamos la experiencia y te dejamos un producto sólido y escalable.",
      image: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=600&q=80",
    },
    {
      title: "Cuando lanzás sin validar",
      subtitle: "Optimización con IA + Diseño UX/UI.",
      description: "Prototipamos y testeamos rápido con herramientas y modelos basados en IA. Así podés validar ideas antes de invertir en desarrollo.",
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12">
        ...
        >
          ...
          <p className="font-['Inter',sans-serif] text-[#000000] max-w-[566px] mx-auto">
            Transformamos esos desafíos en oportunidades con diseño, estrategia e inteligencia aplicada.
          </p>
        </motion.div>
